...
<div role="img" class="section-background-image"
   ...
   <div class="container text-center" style="background-color: #E8E7E7; opacity:98%">
       ...
       <div id="app">
           <div class="pt-1 text-center">
              <div class="pb-3" style="font-size:160%;">
                <div class="pb-1" style="border:2px; border-radius:10px; margin-left:17%; margin-right:17%; background-image:linear-gradient(-90deg, #B56016, #B51616, #760C0C, #B51616, #B56016); color:white; opacity:92%">
                    Select Movies from our <?php echo e(4 ?? $catalogue->count()); ?> Categories
                 </div>
              </div>
           </div>

           <div class="h4 text-left pl-5 pb-1 pt-1"><?php echo e($catalogue->where('id', 1)->first()->name ?? "Category Not Available"); ?></div>
           <div class="row pb-4">
           ...
           <div class="h4 text-left pl-5 pb-1 pt-2"><?php echo e($catalogue->where('id', 2)->first()->name ?? "Category Not Available"); ?></div>
           <div class="row  pb-4">
               <div class="col-3 w-100">
           ...
           <div class="h4 text-left pl-5 pb-1 pt-2"><?php echo e($catalogue->where('id', 3)->first()->name ?? "Category Not Available"); ?></div>
           <div class="row pb-4">
               <div class="col-3 w-100">
